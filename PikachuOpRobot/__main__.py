...
PM_START_TEXT = f"""
`𝐇𝐢..𝐖𝐞𝐥𝐜𝐨𝐦𝐞` [😎](https://telegra.ph/file/8f425cf28d936895eed8b.png)
`𝐈'𝐦` ｄｏｒｅａｍｏｎ 🤗
...
buttons += [[InlineKeyboardButton(text="👾 𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐆𝐫𝐨𝐮𝐩 👾",
                                  url="t.me/Pikachu_op_robot?statgroup=true"),
]]
...
HELP_STRINGS = f"""
`𝐇𝐢.. 𝐈'𝐦` ｄｏｒｅａｍｏｎ [😎](https://telegra.ph/file/a2524e793e86191e66cbb.png)
...
def start(update, context):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("𝐇𝐞𝐲𝐚...,ｄｏｒｅａｍｏｎ 🔥 𝐇𝐞𝐫𝐞,𝐇𝐨𝐰 𝐂𝐚𝐧 𝐈 𝐇𝐞𝐥𝐩 𝐘𝐨𝐮? 🧐")
