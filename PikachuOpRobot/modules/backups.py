...
from PikachuOpRobot.modules.sql import warns_sql as warnssql
import PikachuOpRobot.modules.sql.blacklist_sql as blacklistsql

from PikachuOpRobot.modules.sql import cust_filters_sql as filtersql
import PikachuOpRobot.modules.sql.welcome_sql as welcsql
import PikachuOpRobot.modules.sql.locks_sql as locksql
import PikachuOpRobot.modules.sql.notes_sql as sql

from PikachuOpRobot.modules.rules import get_rules
import PikachuOpRobot.modules.sql.rules_sql as rulessql
from PikachuOpRobot import DEV_USERS, LOGGER, MESSAGE_DUMP, OWNER_ID, dispatcher
from PikachuOpRobot.__main__ import DATA_IMPORT
...
from PikachuOpRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open(
            "PikachuOpRobot{}.backup".format(chat_id),
            "rb"),
        caption="*Successfully backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `PikachuOpRobot` Backup is specially made for notes.".format(
            chat.title,
            chat_id,
            tgl),
        timeout=360,
    ...
    os.remove("PikachuOpRobot{}.backup".format(chat_id))  # Cleaning file
...
*Only for chat administrator:*
 ...
 ➩ /import: Reply to the backup file for the Butler / Pikachu group to import as much as possible, making transfers very easy! \
