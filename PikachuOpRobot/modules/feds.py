...
import PikachuOpRobot.modules.sql.feds_sql as sql
...
from PikachuOpRobot.modules.helper_funcs.alternate import (
    send_action,
    send_message,
    typing_action,
)
...
# Time spended on updating version to v2 = 26+ hours by @Alone_Shadow_x
#
